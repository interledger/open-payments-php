...
class GetOutgoingPayment extends \OpenPayments\OpenApi\Generated\ResourceServer\Runtime\Client\BaseEndpoint implements \OpenPayments\OpenApi\Generated\ResourceServer\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        return str_replace(['{id}'], [$this->id], '/outgoing-payments/{id}');
    }
     ...
     *
     * @return null|\OpenPayments\OpenApi\Generated\ResourceServer\Model\OutgoingPayment
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'OpenPayments\OpenApi\Generated\ResourceServer\Model\OutgoingPayment', 'json');
        }
        if (401 === $status) {
            throw new \OpenPayments\OpenApi\Generated\ResourceServer\Exception\GetOutgoingPaymentUnauthorizedException($response);
        }
        if (403 === $status) {
            throw new \OpenPayments\OpenApi\Generated\ResourceServer\Exception\GetOutgoingPaymentForbiddenException($response);
        }
        if (404 === $status) {
            throw new \OpenPayments\OpenApi\Generated\ResourceServer\Exception\GetOutgoingPaymentNotFoundException($response);
        }
    }
