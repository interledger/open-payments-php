...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PublicIncomingPaymentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \OpenPayments\OpenApi\Generated\ResourceServer\Model\PublicIncomingPayment::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \OpenPayments\OpenApi\Generated\ResourceServer\Model\PublicIncomingPayment::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \OpenPayments\OpenApi\Generated\ResourceServer\Model\PublicIncomingPayment();
        ...
        {
            $data = [];
            if ($object->isInitialized('receivedAmount') && null !== $object->getReceivedAmount()) {
                $data['receivedAmount'] = $this->normalizer->normalize($object->getReceivedAmount(), 'json', $context);
            }
            $data['authServer'] = $object->getAuthServer();
        ...
        {
            return [\OpenPayments\OpenApi\Generated\ResourceServer\Model\PublicIncomingPayment::class => false];
        }
    }
} else {
    class PublicIncomingPaymentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
